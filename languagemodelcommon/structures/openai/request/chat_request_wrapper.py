...
class ChatRequestWrapper(abc.ABC):
    ...
    def effective_parallel_tool_calls(self) -> Optional[bool]:
        """Return the resolved parallel tool calls flag when available."""
    ...
    def enable_debug_logging(self) -> bool:
        """
        Whether debug logging is enabled for this request.

        When True, detailed error messages and tracebacks may be exposed to the user.
        When False, generic user-friendly error messages are shown to protect internal
