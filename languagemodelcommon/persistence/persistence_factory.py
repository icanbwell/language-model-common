...
class PersistenceFactory:
    ...
    def _resolve_mongo_connection(self) -> tuple[str, str]:
        """Resolve and validate MongoDB connection string and database name."""
        ...
        return connection_string, llm_storage_db_name
    ...
    def create_store(self, persistence_type: str) -> Generator[BaseStore, None, None]:
        if persistence_type == "memory":
            ...
            connection_string, db_name = self._resolve_mongo_connection()
