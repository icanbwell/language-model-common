...
class ToolListCache:
    ...
    def get(self, url: str) -> list[MCPTool] | None:
    ...
    def put(self, url: str, tools: list[MCPTool]) -> None:
        self._cache[url] = _CachedToolList(
            tools=list(tools),
...
async def list_all_tools_cached(
    ...
    *,
    ...
    If ``cache`` is provided and contains a fresh entry for ``url``,
